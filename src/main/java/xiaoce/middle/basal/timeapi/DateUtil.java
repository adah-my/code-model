...
public class DateUtil
{
    ...
    private static final ThreadLocal<SimpleDateFormat> threadLocal = ThreadLocal.withInitial(()-> new SimpleDateFormat(DEFAULT_DATE_PATTERN));

    public static SimpleDateFormat getFormatter(String pattern){
        SimpleDateFormat simpleDateFormat = threadLocal.get();
        simpleDateFormat.applyLocalizedPattern(getPattern(pattern));
    ...
    {
//        testException();
//        testFormatterWithNew();    // 9580毫秒
        testFormatterWithTL();       // 9153毫秒
    }
    ...
    private static void testFormatterWithNew() throws InterruptedException
    {
        ...
        System.out.println("new耗时："+(end-start)+"毫秒");
    ...
    private static void testFormatterWithTL() throws InterruptedException
    {
        ...
        countDownLatch.await();
        long end = System.currentTimeMillis();
        System.out.println("TL耗时："+(end-start)+"毫秒");
